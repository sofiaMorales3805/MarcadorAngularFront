...
export class PartidosService {
  ...
  // === NUEVO: obtener un partido por id ===
getById(id: number) {
  return this.http.get<PartidoDto>(`${this.base}/${id}`);
}

// === NUEVO: cambiar estado del partido (Programado|EnJuego|Finalizado|Pospuesto|Cancelado) ===
cambiarEstado(
  id: number,
  ...
  // === NUEVO: crear partido AMISTOSO (sin torneo/serie) ===
  // Backend: POST /api/partidos  (dto: { fechaHora, equipoLocalId, equipoVisitanteId })
